...
test('every shared runtime is included by the character updater; parent commands have no submodule dependency',()=>{
 ...
 assert.deepEqual(workflow.rules.player_handoff.output_files,['index.html','LICENSE.txt','MEDIA_NOTICE.txt','START_SERVER.ps1','START_SERVER.cmd','START_SERVER.command','START_SERVER.sh','PLAYER_SERVER.py',...JSON.parse(fs.readFileSync(new URL('launchers/TRACKING_FILES.json',template),'utf8'))]);
